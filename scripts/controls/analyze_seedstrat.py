...
summary = {
    'meta': {
        ...
        'input2_n_rows': int(len(df2)),
        'seeds': sorted(df1['transpiler_seed'].unique().tolist()),
        'n_constrained_configs_input1': int(len(per_config)),
